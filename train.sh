#!/bin/bash
export OUTPUT_DIR="/hpc/group/pfisterlab/xc139/childbook/text2img/Hongdou02"
export DATASET_NAME="/hpc/group/pfisterlab/for-lora/training-data/Hongdou"
export VAL_PROMPT="Qingmei"
export MAX_TRAIN_STEPS=2200
export DISABLE_TELEMETRY=YES
export HF_DATASETS_CACHE="/work/xc139/cache/huggingface/datasets"
